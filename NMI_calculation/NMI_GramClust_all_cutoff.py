# calculate the NMI value from the clustering results of GramClust for all cufoffs. By Ze-Gang Wei.
...
usage: python NMI_GramClust_all_cutoff.py --input <otu directory>  -r <reference NMI label file> -s <sequence file>

Example: python NMI_GramClust_all_cutoff.py -i ~/GramClust/ -r tax_assignments_NMI_label.txt -s sequence.fa
----------------------- All file path needs absolute path.
--input/-i      (required) The OTU clustered output file directory by GramClust, need absolute path.
...
"""
	...
	cdhit = {}
	cutoffss = []
	cutoff_all = ['gramclust99','gramclust98','gramclust97','gramclust96','gramclust95','gramclust94','gramclust93','gramclust92','gramclust91','gramclust90',\
		      'gramclust89','gramclust88','gramclust87','gramclust86','gramclust85']
	cutoff_files = {}
