# calculate the NMI value from the clustering results of USEARCH for all cufoffs. By Ze-Gang Wei.
...
usage: python NMI_usearch_all_cutoff.py --input <otu directory>  -r <reference NMI label file> -s <sequence file>

Example: python NMI_usearch_all_cutoff.py -i ~/usearch/ -r tax_assignments_NMI_label.txt -s sequence.fa
----------------------- All file path needs absolute path.
--input/-i      (required) The OTU clustered output file directory by USEARSH, need absolute path.
...
"""
	...
	usearch = {}
	cutoffss = []
	cutoff_all = ['usearch99','usearch98','usearch97','usearch96','usearch95','usearch94','usearch93','usearch92','usearch91','usearch90',\
		      'usearch89','usearch88','usearch87','usearch86','usearch85']
	cutoff_files = {}
