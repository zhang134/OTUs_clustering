# calculate the NMI value from the clustering results of DNACLUST for all cufoffs. By Ze-Gang Wei.
...
usage: python NMI_DNACLUST_all_cutoff.py --input <otu directory>  -r <reference NMI label file> -s <sequence file>

Example: python NMI_DNACLUST_all_cutoff.py -i ~/dnaclust/ -r tax_assignments_NMI_label.txt -s sequence.fa
----------------------- All file path needs absolute path.
--input/-i      (required) The OTU clustered output file directory by DNACLUST, need absolute path.
...
"""
	...
	DBH = {}
	cutoffss = []
	cutoff_all = ['dnaclust99','dnaclust98','dnaclust97','dnaclust96','dnaclust95','dnaclust94','dnaclust93','dnaclust92','dnaclust91','dnaclust90',\
		      'dnaclust89','dnaclust88','dnaclust87','dnaclust86','dnaclust85',]
	cutoff_files = {}
