# calculate the NMI value from the clustering results of DBH for all cufoffs. By Ze-Gang Wei.
...
usage: python NMI_DBH_all_cutoff.py --input <otu directory>  -r <reference NMI label file> -s <sequence file>

Example: python NMI_DBH.py -i ~/dbh/ -r tax_assignments_NMI_label.txt -s sequence.fa
...
"""
	...
	DBH = {}
	cutoffss = []
	cutoff_all = ['dbh99','dbh98','dbh97','dbh96','dbh95','dbh94','dbh93','dbh92','dbh91','dbh90',\
		      'dbh89','dbh88','dbh87','dbh86','dbh85',]
	cutoff_files = {}
